...
type MarketAssetController struct {
	baseController
}

func (Self *MarketAssetController) Index() {
	var srv services.MarketAssetService
	...
	Self.TplName = "market_asset/index.html"
}


func (Self *MarketAssetController) Add() {
	Self.Layout = "public/base.html"
	Self.TplName = "market_asset/add.html"
}


func (Self *MarketAssetController) Create() {
	var (
		vForm form_validate.MarketAssetForm
		srv services.MarketAssetService
	)
...
func (Self *MarketAssetController) Edit() {
	...
	Self.Data["data"] = ver
	Self.Layout = "public/base.html"
	Self.TplName = "market_asset/edit.html"
}

func (Self *MarketAssetController) Update(){
	var (
		vForm form_validate.MarketAssetForm
		srv services.MarketAssetService
	)
...
func (Self *MarketAssetController) Del() {
